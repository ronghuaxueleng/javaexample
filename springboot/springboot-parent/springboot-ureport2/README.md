...
依赖 [ureport2](https://github.com/youseries/ureport) （ureport2 可以轻松实现复杂的中国式报表，功能十分强大）
...
```properties
# 配置模板存放的位置
ureport.fileStoreDir=E:/codes/java/eclipse/javaexample/springboot/springboot-parent/springboot-ureport2/src/main/resources/ureportfiles
```
